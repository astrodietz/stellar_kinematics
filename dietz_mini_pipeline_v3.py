...
import datetime
import collections
import staeckel_orbit_v2 as staeckel_orbit
import sys
...
global Xsun
Xsun = 8.2 #Bland-Hawthorne 2016
global Zsun
Zsun = 0.
global vcirc
vcirc = 236. #Kawata 2019
global vsun
vsun1 = [-11.10, 12.24 + vcirc, 7.25] #Schonrich 2010

global vsun2
vsun2=[-11.10,12.24,7.25] #Schonrich 2010
...
def uvw_unc(req_dict, opt_dict):
	...
	cov_radec[0,1]=opt_dict['c_pmrapmdec']*opt_dict['epmra']*opt_dict['epmdec']
	cov_radec[1,0]=opt_dict['c_pmrapmdec']*opt_dict['epmra']*opt_dict['epmdec']
...
def orbit_N(method,req_dict, opt_dict, calc_dict):
	...
	for i in range(0,N_orbits):
		...
		mean=[req_dict['ra'],req_dict['dec'],plx,req_dict['pmra'],req_dict['pmdec'],req_dict['rv']]
		...
		cov_45=opt_dict['c_pmrapmdec']*opt_dict['epmra']*opt_dict['epmdec']
		...
		cov_54=opt_dict['c_pmrapmdec']*opt_dict['epmra']*opt_dict['epmdec']
		...
		rand_dict['pml'], rand_dict['pmb'] = b_c.pmrapmdec_to_pmllpmbb(rand_dict['pmra'], rand_dict['pmdec'], rand_dict['ra'], rand_dict['dec'], degree=True, epoch=2000.0)
...
def reset():
	...
	#extra params
	opt_params=collections.OrderedDict([('era',-9.999),('edec',-9.999),('edist',-9.999),('epmra',-9.999),('epmdec',-9.999),('erv',-9.999),
	('c_radec',-9.999),('c_raplx',-9.999),('c_rapmra',-9.999),('c_rapmdec',-9.999),('c_rarv',-9.999),
	('c_decplx',-9.999),('c_decpmra',-9.999),('c_decpmdec',-9.999),('c_decrv',-9.999),
	('c_plxpmra',-9.999),('c_plxpmdec',-9.999),('c_plxrv',-9.999),
	('c_pmrapmdec',-9.999),('c_pmrarv',-9.999),
	('c_pmdecrv',-9.999)])
